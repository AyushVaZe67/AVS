...
import 'package:bytemind1/models/product1.dart';
  ...
  final Map<String, List<Product1>> shopProducts = {
    'Electronics Shop 1': [
      Product1(
        name: 'मोबाईल',
        price: 30,
        imageAsset: 'assets/images/p1_suit.png',
        url: '', // No URL for Toy Shop products
      ),
      Product1(
        name: 'इअरबड्स',
        price: 50,
        imageAsset: 'assets/images/earbuds.png',
        url: '',
      ),
      Product1(
        name: 'वायर्ड इअरफोन',
        price: 20,
        imageAsset: 'assets/images/wired1.png',
        url: '',
      ),
    ],
    'Books Shop': [
    ...
    'Clothes Shop': [
      ...
      Product1(
        name: 'शेरवानी',
        price: 60,
        imageAsset: 'assets/images/sherwani.png',
        url: '',
      ),
      Product1(
        name: 'साडी',
        price: 80,
        imageAsset: 'assets/images/p2_saree.png',
        url: '',
      ),
    ],
  };
